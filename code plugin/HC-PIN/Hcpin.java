...
public class Hcpin extends Plugin implements NewAlgorithm{
	...
	public Vector[] getClusters(String[] para) {
		...
		int size = GraphInfo.nodelist.size();
		double[][] weights = new double[size][size];
			...
			for(int i=0;i<edgelist.size();i++){
				...
				weights[index1][index2] = tempedge.getWeight();
				weights[index2][index1] = tempedge.getWeight();
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "a cluster algorithm named HC-PIN which has two paramater:Threshold and ComplexSize.";
	}
